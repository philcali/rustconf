...
impl<'a> OperationsGenerator<'a> {
    ...
    pub fn generate_http_transport(&self) -> String {
        ...
        output.push_str("///\n");
        output.push_str(
            "/// This example shows a complete custom transport implementation that adds\n",
        );
        output.push_str(
            "/// custom headers, implements retry logic, and uses a custom HTTP client.\n",
        );
        output.push_str("///\n");
        output.push_str("/// ```rust,ignore\n");
        ...
        output.push_str("/// use my_bindings::*;\n");
        output.push_str("///\n");
        output.push_str("/// /// Custom transport with retry logic and custom headers.\n");
        output.push_str("/// struct MyCustomTransport {\n");
        output.push_str("///     client: reqwest::Client,\n");
        output.push_str("///     max_retries: u32,\n");
        output.push_str("///     custom_header_value: String,\n");
        output.push_str("/// }\n");
        output.push_str("///\n");
        output.push_str("/// impl MyCustomTransport {\n");
        output.push_str("///     pub fn new(custom_header_value: String) -> Self {\n");
        output.push_str("///         Self {\n");
        output.push_str("///             client: reqwest::Client::builder()\n");
        output.push_str("///                 .timeout(std::time::Duration::from_secs(30))\n");
        output.push_str("///                 .build()\n");
        output.push_str("///                 .expect(\"Failed to create HTTP client\"),\n");
        output.push_str("///             max_retries: 3,\n");
        output.push_str("///             custom_header_value,\n");
        output.push_str("///         }\n");
        output.push_str("///     }\n");
        output.push_str("/// }\n");
        output.push_str("///\n");
        ...
        output.push_str("///     async fn execute(&self, mut request: HttpRequest) -> Result<HttpResponse, RpcError> {\n");
        output.push_str("///         // Add custom header to all requests\n");
        output.push_str("///         request.headers.push((\n");
        output.push_str("///             \"X-Custom-Header\".to_string(),\n");
        output.push_str("///             self.custom_header_value.clone()\n");
        output.push_str("///         ));\n");
        output.push_str("///         \n");
        output.push_str("///         // Retry logic\n");
        output.push_str("///         let mut last_error = None;\n");
        output.push_str("///         for attempt in 0..=self.max_retries {\n");
        output.push_str("///             if attempt > 0 {\n");
        output.push_str("///                 // Wait before retrying (exponential backoff)\n");
        output.push_str("///                 tokio::time::sleep(\n");
        output.push_str(
        ...
        output.push_str("///             if let Some(ref body) = request.body {\n");
        output.push_str("///                 req_builder = req_builder.body(body.clone());\n");
        output.push_str("///             }\n");
        output.push_str("///             \n");
        output.push_str("///             // Execute request\n");
        output.push_str("///             match req_builder.send().await {\n");
        ...
        output.push_str("///                         .map_err(|e| RpcError::TransportError(\n");
        output.push_str(
        ...
        output.push_str("///                     \n");
        output.push_str("///                     return Ok(HttpResponse {\n");
        ...
        output.push_str("///                     last_error = Some(e);\n");
        output.push_str("///                     // Continue to next retry attempt\n");
        output.push_str("///                 }\n");
        output.push_str("///             }\n");
        output.push_str("///         }\n");
        output.push_str("///         \n");
        output.push_str("///         // All retries failed\n");
        output.push_str("///         Err(RpcError::TransportError(\n");
        output.push_str("///             format!(\"HTTP request failed after {} retries: {}\",\n");
        output.push_str("///                 self.max_retries,\n");
        output.push_str("///                 last_error.unwrap())\n");
        output.push_str("///         ))\n");
        output.push_str("///     }\n");
        output.push_str("/// }\n");
        output.push_str("///\n");
        ...
        output.push_str("/// async fn main() -> Result<(), RpcError> {\n");
        output.push_str(
            "///     let transport = MyCustomTransport::new(\"my-app-v1.0\".to_string());\n",
        );
        output.push_str("///     let client = RestconfClient::new(\n");
        output.push_str("///         \"https://device.example.com\",\n");
        output.push_str("///         transport\n");
        output.push_str("///     )?;\n");
        output.push_str("///     \n");
        output.push_str("///     // Use the client with your custom transport\n");
        output.push_str("///     // let result = some_rpc_function(&client, input).await?;\n");
        output.push_str("///     \n");
        output.push_str("///     Ok(())\n");
        output.push_str("/// }\n");
